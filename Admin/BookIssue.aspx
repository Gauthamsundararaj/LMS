    ...
    <form id="form1" runat="server">
        ...
        <div class="page-body ">
            ...
            <div class="container-fluid mt-2">
                <%--------- Form Start ---------%>
                <div class="card" id="divForm" runat="server" visible="true">
                    <div class="container">
                        ...
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Student Form -->
                                <div class="row">
                                    <div id="divStudent" class="col-md-3" runat="server" visible="false">
                                    ...
                                    <!-- Staff Form -->
                                    <div id="divStaff" class="col-md-3" runat="server" visible="false">
                                    ...
                                    <div id="divIssueDetails" class="col-md-9" runat="server" visible="false">
